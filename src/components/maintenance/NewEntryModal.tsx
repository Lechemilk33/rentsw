/*
 * NewEntryModal - Professional maintenance entry form
 * Comprehensive form for logging maintenance activities
 */

import React, { useState, useEffect, useRef } from 'react'
import { X, Wrench, Plus, Trash, User } from 'phosphor-react'
...
interface NewEntryModalProps {
  isOpen: boolean
  onClose: () => void
  onSubmit: (data: MaintenanceEntryData) => Promise<void>
  vehicles: Vehicle[]
...
export const NewEntryModal: React.FC<NewEntryModalProps> = ({
  ...
  const [formData, setFormData] = useState<MaintenanceEntryData>({
    vehicle_id: '',
    mileage: 0,
  ...
  const handleInputChange = (field: keyof MaintenanceEntryData, value: any) => {
        ...
        <Card padding="lg" className="card-responsive">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Vehicle Selection */}
              <div>
                <label htmlFor="vehicle_id" className="block text-responsive-sm font-medium text-gray-700 mb-2">
                  Vehicle *
                </label>
                <select
                  id="vehicle_id"
              ...
              {/* Current Mileage */}
              <div>
                <label htmlFor="mileage" className="block text-responsive-sm font-medium text-gray-700 mb-2">
                  Current Mileage *
                </label>
                <Input
                  id="mileage"
            ...
            {/* Work Performed */}
            <div>
              <label htmlFor="work_performed" className="block text-responsive-sm font-medium text-gray-700 mb-2">
                Work Performed *
              </label>
              <textarea
                id="work_performed"
                ...
                {formData.parts_used.length > 0 && (
                  <div className="space-y-2">
                    {formData.parts_used.map((part, index) => (
                      <div key={`part-${index}-${part}`} className="flex items-center justify-between bg-gray-50 p-3 rounded">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="labor_hours" className="block text-responsive-sm font-medium text-gray-700 mb-2">
                  Labor Hours
                </label>
                <Input
                  id="labor_hours"
              ...
              <div>
                <label htmlFor="cost" className="block text-responsive-sm font-medium text-gray-700 mb-2">
                  Total Cost
                </label>
                <Input
                  id="cost"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="next_service_due" className="block text-responsive-sm font-medium text-gray-700 mb-2">
              ...
              <div>
                <label htmlFor="next_service_mileage" className="block text-responsive-sm font-medium text-gray-700 mb-2">
